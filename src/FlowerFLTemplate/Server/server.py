...
class Server:
    ...
    def fit(self, num_rounds: int, timeout: float | None) -> tuple[History, float]:
        ...
        self._initial_evaluation(history)
        ...
        for current_round in range(1, num_rounds + 1):
            ...
            self._fit_round_distributed(current_round, timeout, history)
            self._evaluate_round_centralized(current_round, history, start_time)
            self._evaluate_round_distributed(current_round, timeout, history)
    ...
    def _initial_evaluation(self, history: History) -> None:
    ...
    def _fit_round_distributed(
        self, current_round: int, timeout: float | None, history: History
    ) -> None:
    ...
    def _evaluate_round_centralized(
        self, current_round: int, history: History, start_time: float
    ) -> None:
    ...
    def _evaluate_round_distributed(
        self, current_round: int, timeout: float | None, history: History
    ) -> None:
