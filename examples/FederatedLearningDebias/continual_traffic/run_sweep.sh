PROJECT_NAME="Sweep_Continual_Traffic" # swap out globally
...
run_sweep_and_agent "baseline_dp_1.0"
run_sweep_and_agent "fixed_005"
run_sweep_and_agent "tunable_005"

# run_sweep_and_agent "baseline"
# run_sweep_and_agent "fixed_005_NO_DP"
# run_sweep_and_agent "tunable_005_NO_DP"
