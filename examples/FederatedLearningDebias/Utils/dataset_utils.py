...
import numpy as np
import torch
from Utils.celeba import CelebaDataset, CelebaDatasetHairColor
...
class DatasetUtils:
    ...
    def download_dataset(
        ...
        elif dataset_name == "celeba_hair":
            return DatasetUtils.download_celeba_hair(
                train_csv=train_csv,
                test_csv=test_csv,
                base_path=base_path,
                debug=debug,
            )
        elif dataset_name == "dutch" or dataset_name == "dutch_unprivileged":
