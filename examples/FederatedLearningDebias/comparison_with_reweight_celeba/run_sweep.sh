...
run_sweep_and_agent () {
  ...
  poetry run wandb agent $SWEEP_ID --project "$PROJECT_NAME" --count 200
}


#run_sweep_and_agent "celeba_local_tunable_disparity"
run_sweep_and_agent "celeba_global_tunable_disparity"
