PROJECT_NAME="Centralised_Debias_Celeba" # swap out globally
...
# run_sweep_and_agent "baseline_celeba_DP_8"
# run_sweep_and_agent "celeba_007_dp_5"

# run_sweep_and_agent "celeba_007_NO_DP"
run_sweep_and_agent "celeba_007_dp_5_tunable"