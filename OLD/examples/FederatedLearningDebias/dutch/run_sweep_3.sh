PROJECT_NAME="Dutch_comparison" # swap out globally
...
run_sweep_and_agent "baseline_dp_4"
# run_sweep_and_agent "dutch_tunable_private_3"
# run_sweep_and_agent "dutch_tunable_private_3_dp"