PROJECT_NAME="Dutch_comparison_eq_odds" # swap out globally
...
run_sweep_and_agent "fixed_0.1_eq_odds"
# run_sweep_and_agent "dutch_tunable_private_1"
# run_sweep_and_agent "dutch_tunable_private_1_dp"
