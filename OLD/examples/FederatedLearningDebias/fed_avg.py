...
class FedAvg(Strategy):
    ...
    def aggregate_fit(
        ...
        if self.fit_metrics_aggregation_fn:
            ...
            # if "Training Disparity with statistics no noise" in metrics_aggregated:
            #     current_unfairness = metrics_aggregated[
            #         "Training Disparity with statistics no noise"
            #     ]
            #     self.unfairness_history.append(current_unfairness)
