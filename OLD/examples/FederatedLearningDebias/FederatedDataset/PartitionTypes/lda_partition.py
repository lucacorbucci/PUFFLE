...
class LDAPartition:
    def do_partitioning(
        ...
        splitted_indexes_test = {str(index): partition[0] for index, partition in enumerate(partitions)}

        labels_per_cluster_test = {str(index): labels[partition[0]] for index, partition in enumerate(partitions)}
