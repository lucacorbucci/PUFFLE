    ...
    def do_partitioning(
        ...
        for (
            ...
            for target, percentage in percentage_details.items():
                selected_indexes = target_indexes[target][: int(percentage / 100 * target_indexes_sizes[target])]
                ...
                target_indexes[target] = target_indexes[target][int(percentage / 100 * target_indexes_sizes[target]) :]
