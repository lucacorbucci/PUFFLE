...
# for i in $(seq 0 7);
# do
#     poetry run python /home/lcorbucci/Unfairness-Regularization/examples/FederatedLearningDebias/continual_income/../main.py  --run_name tunable_01_DP_1 --node_shuffle_seed $i --project_name Continual_Income --alpha_target_lambda=2.311878409528324 --batch_size=2976 --clipping=4.706035836860158 --epochs=4 --lr=0.04744944542372344 --momentum=0.14357942261280063 --optimizer=adam --weight_decay_lambda=0.010515960718797596 --dataset continual_income --num_rounds 45 --num_client_cpus 1 --num_client_gpus 0.05 --pool_size 150 --sampled_clients 0.18 --sampled_clients_test 1 --debug False --base_path ../../../../data/continual_income/ --dataset_path ../../../../data/continual_income/ --seed 42 --wandb True  --training_nodes 0.67 --test_nodes 0.335 --tabular_data True --metric disparity --splitted_data_dir federated_3 --switch_dataset 5 --ratio_unfair_nodes 0.5 --epsilon 0.9 --epsilon_lambda 0.1 --regularization_mode tunable --regularization True --target 0.1
# done
...
for i in $(seq 0 7);
do
    poetry run python /home/lcorbucci/Unfairness-Regularization/examples/FederatedLearningDebias/continual_income/../main.py --alpha_target_lambda=2.572579240243767 --run_name tunable_015_NO_DP --node_shuffle_seed $i --project_name Continual_Income --batch_size=3901 --epochs=5 --lr=0.03267509527015567 --momentum=0.6131627769014412 --optimizer=adam --weight_decay_lambda=0.34682341076776385 --dataset continual_income --num_rounds 45 --num_client_cpus 1 --num_client_gpus 0.05 --pool_size 150 --sampled_clients 0.18 --sampled_clients_test 1 --sampled_clients_validation 0 --debug False --base_path ../../../../data/continual_income/ --dataset_path ../../../../data/continual_income/ --seed 42 --wandb True  --training_nodes 0.67 --test_nodes 0.335 --tabular_data True --metric disparity --splitted_data_dir federated_2 --switch_dataset 5 --ratio_unfair_nodes 0.5 --regularization_mode tunable --regularization True --target 0.15
done
