...
class Server:
    ...
    def fit(self, num_rounds: int, timeout: Optional[float]) -> History:
        ...
        for current_round in range(1, num_rounds + 1):
            if (
                self.args.dataset == "continual_income"
                or self.args.dataset == "continual_traffic"
                or self.args.dataset == "continual_dutch"
                and self.args.switch_dataset
            ):
                ...
                if dataset_id > 1:
                    dataset_id = 1
                # remove what is in the middle of the two comments.
