...
class CelebaDataset(Dataset):
    ...
    def __init__(
        ...
        smiling_dict = {-1: 0, 1: 1, 0: 0}
        targets = [smiling_dict[item] for item in dataframe["Smiling"].tolist()]
        self.targets = targets
        self.sensitive_attributes = [smiling_dict[item] for item in dataframe["Male"].tolist()]
...
class CelebaDatasetData(Dataset):
    """Definition of the dataset used for the Celeba Dataset."""
...
class CelebaDatasetHairColor(Dataset):
    ...
    def __init__(
        ...
        # self.targets = targets
        smiling_dict = {-1: 0, 1: 1, 0: 0}
        targets = [smiling_dict[item] for item in dataframe["Attractive"].tolist()]
        self.targets = targets
        self.sensitive_attributes = dataframe["Hair_Color"].tolist()
        self.samples = list(dataframe["image_id"])
        self.n_samples = len(dataframe)
        self.transform = transform
        self.image_path = image_path
