...
from Models.logistic_regression_net_valerio import LinearClassificationNetValerio
...
class ModelUtils:
    ...
    def get_model(
        ...
        """
        if dataset == "celeba" or dataset == "celeba_hair":
            return CelebaNet()
        elif dataset == "dutch":
        ...
        elif dataset == "dutch_unprivileged_poisoned":
            return LinearClassificationNet(input_size=12, output_size=2)
        elif dataset == "german":
            return LinearClassificationNet(input_size=11, output_size=2)
        elif dataset == "adult":
        ...
        elif dataset == "continual_income":
            return LinearClassificationNet(input_size=53, output_size=2)
        elif dataset == "continual_dutch":
            return LinearClassificationNet(input_size=11, output_size=2)
        elif dataset == "continual_traffic":
            return LinearClassificationNet(input_size=73, output_size=2)
        elif dataset == "income_valerio":
            return LinearClassificationNetValerio(input_size=54, output_size=2)
        elif dataset == "dutch_valerio":
            return LinearClassificationNetValerio(input_size=11, output_size=2)
