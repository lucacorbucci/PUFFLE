PROJECT_NAME="Celeba_continual" # swap out globally
...
# run_sweep_and_agent "fixed_DP"
# run_sweep_and_agent "tunable_DP"
run_sweep_and_agent "tunable_DP_2"
run_sweep_and_agent "fixed_DP_2"
