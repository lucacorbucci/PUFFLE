PROJECT_NAME="Celeba_comparison_distributions" # swap out globally
...
#run_sweep_and_agent "original_merged"
# run_sweep_and_agent "reduced_50"
# run_sweep_and_agent "reduced_90"
# run_sweep_and_agent "label_flipping"
run_sweep_and_agent "label_flipping_90"
run_sweep_and_agent "label_flipping_both"
