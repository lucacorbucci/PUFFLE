...
# run_sweep_and_agent "baseline_celeba_DP_5"
# run_sweep_and_agent "celeba_011_dp_5"

# run_sweep_and_agent "celeba_011_NO_DP"
run_sweep_and_agent "celeba_011_dp_5_tunable"