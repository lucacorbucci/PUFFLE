...
from utils.celeba import CelebaDatasetHairColor
...
train_dataset = CelebaDatasetHairColor(
    csv_path="../dataset/celeba/train_with_validation_hair.csv",
    image_path="../dataset/celeba/img_align_celeba",
    transform=transform,
    debug=True,
)
validation_dataset = CelebaDatasetHairColor(
    csv_path="../dataset/celeba/validation_hair.csv",
    image_path="../dataset/celeba/img_align_celeba",
    transform=transform,
    debug=True,
)
test_dataset = CelebaDatasetHairColor(
    csv_path="../dataset/celeba/test_hair.csv",
    image_path="../dataset/celeba/img_align_celeba",
    transform=transform,
    debug=True,
)
